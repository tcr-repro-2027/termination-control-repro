\caption{One-for-one target replacement. Input, record count and per-record block count are held fixed; only which target blocks are out-of-candidate moves. 24.3\% is in Appendix A.}
\begin{tabular}{lrrrrrrrrr}
\toprule
condition & replacement\_rate & train\_seed & records & target\_blocks & continuous\_pattern\_repetition & stable\_token\_orbit & hit\_context\_limit & entity\_pair\_f1 & out\_of\_candidate\_blocks \\
\midrule
