\caption{Raw versus entity-constraint-cleaned supervision. Rates are over all responses; F1 is pooled micro-F1.}
\begin{tabular}{lllrrrrrrr}
\toprule
scale & condition & train\_seed & n\_responses & continuous\_pattern\_repetition & stable\_token\_orbit & hit\_context\_limit & gen\_tokens\_mean & triple\_f1 & entity\_pair\_f1 \\
\midrule
